...
public class SpringRun {
    ...
    public static void fill() throws ParseException {
        ...
        c1.addCompte(new Compte(c1,2300.0,new SimpleDateFormat("dd/MM/yy").parse("31/01/2010")));
        c2.addCompte(new Compte(c2,5440.0,new SimpleDateFormat("dd/MM/yy").parse("05/07/2001")));
        c2.addCompte(new Livret(c2, 655.0,new SimpleDateFormat("dd/MM/yy").parse("05/07/2011"),0.05));
        c3.addCompte(new Compte(c3, 450.0,new SimpleDateFormat("dd/MM/yy").parse("25/12/2013")));
